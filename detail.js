...
const dayData = predpoved.find((day) => day.datum === dayName);
...
mainElement.innerHTML = `
   <article>
    ...
    <p>${dayData.datum}</p>
    <ul>
      <li>Ráno: ${dayData.ranni_teplota}°C</li>
      <li>Odpoledne: ${dayData.odpoledni_teplota}°C</li>
      <li>Večer: ${dayData.vecerni_teplota}°C</li>
    </ul>
    <p>Stav počasí: ${dayData.stav_pocasi}</p>
    <p>Tlak: ${dayData.tlak} hPa</p>
    <p>Rychlost větru: ${dayData.rychlost_vetru}</p>
    <p>Popis počasí: ${dayData.popis_pocasi}</p>
    </article>
  `;
